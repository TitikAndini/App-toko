...
<form action="" method="post" enctype="multipart/form-data">
	<h2 style="margin-left: 14px;">Input Data Barang</h2>
	<hr>
	<div class="col-md-6">
		...
		<div class="form-group">
			...
			<select name="merek" id="" class="form-control" value="" required>
				<?php if (isset($_GET['edit'])): ?>
					<option value="<?php echo @$edit['kd_merek'] ?>"><?php echo @$edit['merek'] ?></option>
				<?php endif ?>
				<?php if (!isset($_GET['edit'])): ?>
				...
				<?php 
					foreach ($data as $datas) { ?>
						<option value="<?php echo $datas['kd_merek'] ?>"><?php echo $datas['merek'] ?></option>
				<?php } ?>
			</select>
		</div>
		<div class="form-group">
			...
			<select name="dist" id="" class="form-control" required>
				<?php if (isset($_GET['edit'])): ?>
					<option value="<?php echo @$edit['kd_distributor'] ?>"><?php echo @$edit['nama_distributor'] ?></option>
				<?php endif ?>
				<?php if (!isset($_GET['edit'])): ?>
				...
				<?php 
					foreach ($datad as $datas) { ?>
						<option value="<?php echo $datas['kd_distributor'] ?>"><?php echo $datas['nama_distributor'] ?></option>
				<?php } ?>
			</select>
		</div>
	</div>
